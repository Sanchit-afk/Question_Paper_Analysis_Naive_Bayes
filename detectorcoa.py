...
def classify():
    clf = load('coa-classifier.joblib')
    d = make_dict()

            
    modules = [['INTRODUCTION'],['PROCESSOR','ORGANIZATION','AND','ARCHITECTURE'],
                ['CONTROL','UNIT','DESIGN'],['Memory','Organization'],['I/O',' Organization','and','Peripherals'],
...
def custom_classify(filename):
    ...
    return modDict,modules
classify()   
#'INTRODUCTION','PROCESSOR ORGANIZATION AND ARCHITECTURE',
#               'CONTROL UNIT DESIGN','Memory Organization','I/O Organization and Peripherals',
#               'Advanced Processor Principles'
# dictlist = []
# for mod in modDict:
